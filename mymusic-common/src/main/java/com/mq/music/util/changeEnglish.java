...
//    private static changeEnglish changeEnglish = new changeEnglish();
//
//    public static changeEnglish getInstance() {
...
//        return changeEnglish.getInstance().convertAll(str).toUpperCase();
//    }
